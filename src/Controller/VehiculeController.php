...
class VehiculeController extends AbstractController
{
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $this->addFlash('success', 'Le véhicule a été ajouté avce succès.');
    ...
    public function show(Vehicule $vehicule, DisponibiliteRepository $disponibiliteRepsository): Response
    {
        $disponibilites = $disponibiliteRepsository->findBy(['vehicule' => $vehicule]);
